...
public final class Params {
    ...
    private static String homeUrlDefault = "https://site-www.ru/maptrack"; //"http://f99600w0.beget.tech/tracker"; //"http://site-www.ru/maptrack";
    ...
    static boolean isTargetNumber(String number) {
        Log.debug("ISTARGETNumber=  "+number);
        for (User user : usersOut) {
