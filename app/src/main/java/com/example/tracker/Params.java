...
//    static  String addPointUrl = homeUrl+"/add_point.php";
   ...
   // static  String[] phonesIn= {"79585487061", "79081642616"};
    ...
    static String getApiKey(){
        return (Params.apiKey==null?Params.apiKeyDefault:Params.apiKey);
    }
    static  String getAddPointUrl(){
        return (Params.homeUrl==null?Params.homeUrlDefault:Params.homeUrl
                +"/add_point.php?code="+Params.userCode+"&is_log=1&lat=" + Params.latitude + "&lon=" + Params.longitude);
    }
